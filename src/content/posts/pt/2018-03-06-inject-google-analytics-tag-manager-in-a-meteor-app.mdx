...
<ImageFigure alt="Exemplo do código-fonte de um app Meteor com o tag manager do GA injetado" src="/content/posts/2018-03-06-inject-google-analytics-tag-manager-in-a-meteor-app/source-code.png" caption="Exemplo do código-fonte de um app Meteor com o tag manager do GA injetado" />
