...
<ImageFigure alt="Instagram media mosaic at https://x-team.com/join/" src="/content/posts/2018-03-05-fetching-from-instagram-using-facebook-graph-api/instagram-media-mosaic.png" caption="Este módulo foi incluído em https://x-team.com/join/" />
