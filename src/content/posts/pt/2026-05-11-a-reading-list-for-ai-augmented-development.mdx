...
**Anthropic — *Building with Claude* e documentação de *Prompt Engineering*.** A documentação de prompt engineering da Anthropic é excepcionalmente high-signal pra documentação de um vendor. O *prompt engineering interactive tutorial* em particular vale ser trabalhado.
...
## Comunidades e conversas em andamento

Listas de leitura são estáticas. A conversa não é. Alguns lugares onde eu checo:

**Hacker News.** Qualidade errática, ouro ocasional. As threads de `whoishiring`, os lançamentos de novas ferramentas de IA, e as longas discussões sobre papers relacionados a agentes são geralmente onde eu vejo novos participantes sendo debatidos com honestidade.

**Podcast Latent Space.** Provavelmente o melhor programa de entrevistas longas sobre engenharia de IA especificamente. Episódios longos, convidados fortes, o host realmente entende o conteúdo técnico. Eu escuto em velocidade reduzida.

**Twitter/X — o canto de engenharia de IA.** Apesar do declínio geral da plataforma, a conversa específica de engenharia de IA ainda está ativa. Karpathy, Simon Willison, os times da Anthropic e OpenAI, e uma longa cauda de praticantes afiados. Você vai ter que curar agressivamente.

**Comunidades específicas de Discord e Slack.** Essas se movem rápido demais pra eu mencioná-las num post de blog que envelhece — links apodrecem. Pergunte por aí. As boas existem.

## Como ler esta lista

Algumas sugestões se você quiser realmente usar isto ao invés de só admirar.

**Não leia linearmente.** Escolha a seção que mapeia pra lacuna que você está sentindo agora. Se está inseguro sobre o que são modelos, comece com Karpathy. Se seus prompts não estão funcionando, comece com a seção de prompt engineering. Se está tentando entender o cenário de ferramental de agentes, comece com os praticantes. A lista é estruturada pra amostragem, não pra sequenciamento.

**Leia na cadência que a fonte pede.** Os talks do Karpathy são pra assistir devagar. O blog do Simon Willison é leitura diária rápida. Os posts da Lilian Weng são deep-dives de fim de semana. Livros são meses. Não tente igualar todos na mesma velocidade; respeite a cadência que cada um pede.
...
De qualquer forma, vou voltar a escrever um post de cada vez, no ritmo que o trabalho sugerir, sem tag de série. Obrigado por ler.

## Leitura complementar

- [O que eu ainda não aprendi](/pt/2026/05/09/what-i-havent-learned-yet)
- [Guardrails comportamentais para assistentes de coding com IA](/2026/05/01/behavioral-guardrails-for-ai-coding-assistants)
