...
```html
<ImageFigure alt="The alternative textual representation" src="full-path/of/the-image.png" caption="Some helpful caption" />
```
...
```html
<ImageFigure alt="The alternative textual representation" src="path/of/the/image.png" caption="Some helpful caption" />
```
