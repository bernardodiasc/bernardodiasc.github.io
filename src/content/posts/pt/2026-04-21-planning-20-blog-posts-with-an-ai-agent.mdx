---
title: Planejando 20 posts de blog com um agente de IA
date: 2026-04-21
category: ai-work
series: blog-meta
draft: true
...
Olha o que eu não tinha percebido: no agent mode, o modelo quer *fazer alguma coisa*. Ele é enviesado a produzir diffs. Faça uma pergunta vaga e ele vai começar a "corrigir" coisas. Quando você percebe que não queria aquilo, já tem um design meio implementado grudado na árvore.
...
Quando você diz "o que você acha sobre como organizar as categorias?", o modelo te dá um parágrafo ponderado. Você lê, concorda em grande parte, acena, e avançou exatamente um centímetro. Aí ele te faz uma pergunta de volta, você devolve um parágrafo, e depois de trinta minutos disso você percebe que teve uma conversa agradável e tomou três decisões reais.
...
- **Datas e cronologia**: posts no blog são listados por data. Se eu simplesmente desse a todos a data de hoje, a ordem se dissolveria em ruído. Então retroagimos as datas — um por dia, terminando hoje, começando três semanas atrás — para dar a cada post uma URL limpa e uma posição legível no arquivo.
...
A outra coisa que eu não esperava era quanto dinheiro e tempo eu economizaria planejando todos os 21 posts de antemão em vez de escrever um, depois planejar o próximo, e assim por diante.
...
Algumas coisas teriam me economizado umas duas horas se eu soubesse desde o início.

- **Decida as categorias antes de qualquer coisa.** Mudei a lista de categorias no meio do caminho e tive que revisitar cada tópico de post. O conjunto de categorias é a coisa barata de acertar cedo.
- **Escreva a política de segurança primeiro.** Mesma lógica. Se eu tivesse escrito "sem nomes internos, sem nomes de clientes, sem IDs reais" logo na primeira mensagem, as ideias de tópicos teriam chegado já abstraídas.
- **Escolha um registro de voz por post explicitamente.** Alguns posts são casuais, outros são reflexivos. Eu estava deixando implícito, e os rascunhos voltavam num cinza neutro de LLM. Nomear o registro de antemão resolve isso na hora.
- **Não dê título às coisas no plan mode.** Títulos são a parte mais opinada de um post. A primeira tentativa do agente para um título geralmente é genérica demais; a minha é geralmente esperta demais. Deveria ter deixado títulos por último.
...
Enfim. Mais vinte posts na fila depois desse. Vamos ver como isso vai.

## Leitura complementar

- [Ensinando a IA a escrever como eu](/pt/2026/04/22/teaching-ai-how-to-write-like-me)
